...
> Configurations in Tests for more details on using mock configuration
> during tests.
...
Many Observability back-ends visualize traces as waterfall diagrams.
