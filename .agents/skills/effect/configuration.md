...
| `logLevel` | Reads a value as a LogLevel.                                       |
...
For more information, see the Schema.Config documentation.
...
> **Tip**: In this example, we use `ConfigProvider.fromMap` to create a
