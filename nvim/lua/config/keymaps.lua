...
vim.keymap.set("n", "h", vim.cmd.undo, { desc = "Undo" })
vim.keymap.set("n", "H", vim.cmd.redo, { desc = "Redo" })
vim.keymap.set("n", "l", "i", { desc = "Insert" })
vim.keymap.set("n", "L", "I", { desc = "Insert" })
vim.keymap.set({ "n", "v" }, "j", "e", { desc = "End word" })
vim.keymap.set("n", "k", "p", { desc = "Paste" })
vim.keymap.set("n", "K", "P", { desc = "Paste" })
vim.keymap.set("x", "k", "P", { desc = "Paste" })
vim.keymap.set("x", "K", "p", { desc = "Paste" })
...
vim.keymap.set("n", "P", vim.lsp.buf.signature_help, { desc = "Signature help" })
vim.keymap.set("n", "I", vim.lsp.buf.hover, { desc = "Hover" })
